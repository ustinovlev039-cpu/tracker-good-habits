...
## Запуск проекта можно еще через Docker Compose 

Для запуска всех компонентов проекта необходимы Docker и Docker Compose.

В корне проекта скопируйте пример переменных окружения:
